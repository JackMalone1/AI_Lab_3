...
void PursueBehaviour::update(Character* t_character, float t_deltaTime)
{
	...
	{
		sf::Vector2f direction = *t_character->getTargetPosition() - t_character->getPosition();
		...
		sf::Vector2f targetPosition = *t_character->getTargetPosition() + sf::Vector2f(0.0f, 0.0f) * timePrediction;
